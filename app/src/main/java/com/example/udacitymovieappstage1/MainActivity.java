package com.example.udacitymovieappstage1;
...
import com.example.udacitymovieappstage1.Utils.NetworkUtil;
...
public class MainActivity extends AppCompatActivity implements MovieAdapter.MovieItemClickListener {
    ...
    private void makeSearchQuery() {
        if(isOnline()) {
            URL MovieUrl = NetworkUtil.buildUrl(sortPopular);
    ...
    public static void showPosterGrid(){
